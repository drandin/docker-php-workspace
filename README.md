...
- Возможность одновременно использовать для различных web-проектов разные версии PHP.
- Готовый к использованию монитор процессов **Supervisor**.
...
- Базы данных:
  ...
  - **MongoDB 4.2**.
  - **Redis** (latest).
- Настройка параметров окружения через **.env**.
...
- Каталоги большинства docker-контейнеров, в которых хранятся пользовательские данные и параметры конфигурации смонтированные на локальную машину.
